...
int main(){
	...
	if(y1>y4 || y3>y2) return 0;
	if(x4>x2 && x2>x3 && x3>x1 && y4>y2 && y2>y3 && y3>y1){
		printf("%.2f",(x2-x3)*(y2-y3));
	}
	if(x2>x3 && x3>x1 && x4>x2 && y2>y4 && y4>y1 && y1>y3){
		printf("%.2f",(x2-x3)*(y4-y1));
	}
	if(x2==x4 && x2>x3 && x3>x1 && y2==y4 && y1>y3){
		printf("%.2f",(x2-x3)*(y2-y1));
	}
}
*/
